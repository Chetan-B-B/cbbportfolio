      ...
      <div className="px-6 mx-auto text-center max-w-7xl">
        ...
        <div className="text-center">
          <div className="flex items-center justify-center space-x-3">
                    ...
                    <p className="text-lg italic font-normal  text-[#00000080]">I&apos;m Available </p>
        ...
        {/* Title */}
        <h2 className="mt-2 font-serif text-5xl font-semibold md:text-6xl">
          Let&apos;s <span className="italic text-gray-300">Connect</span>
        </h2>
